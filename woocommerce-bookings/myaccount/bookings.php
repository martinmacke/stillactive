				...
				?>
					<tr>
						...
						<td class="booking-cancel">
							...
							<a href="<?php echo esc_url( $booking->get_cancel_url() ); ?>" class="button cancel" onclick="return confirm('Are you sure you want to Cancel <?php echo esc_html( $booking->get_product()->get_title() ); ?>?');"><?php esc_html_e( 'Cancel', 'woocommerce-bookings' ); ?></a>
							<?php endif; ?>
						</td>
					</tr>
				<?php /* endif; */ ?>
